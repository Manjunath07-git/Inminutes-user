          ...
          :[...userOrders].reverse().map(o=>{
            ...
            return <div key={o.id} className="ordcard" style={{marginBottom:14}}>
              ...
              <div style={{display:"flex",alignItems:"center",marginBottom:14,padding:"12px 10px",background:"var(--s2)",borderRadius:12}}>
                {steps.map((s,i)=><>
                  <div key={s} style={{display:"flex",flexDirection:"column",alignItems:"center",flex:i<3?0:undefined}}>
                  ...
                  {i<3&&<div key={"l"+i} style={{flex:1,height:2,background:i<cur?"var(--a)":"var(--b)",margin:"0 2px",marginBottom:16,transition:"background .3s"}}/>}
                </>)}
              </div>
